...
import { getMedicationsTableAnalytics, getPharmaciesTableAnalytics, getRegionsChartsAnalytics, getMedicationsChartsAnalytics, getPharmaciesChartsAnalytics, getDemandChartsAnalytics, getSummaryAnalytics } from "../controllers/analyticsController.js";
import authenticate from "../../../middlewares/authenticate.js";
import authorize from "../../../middlewares/authorize.js";

const router = express.Router();

router.get("/summary", authenticate, authorize("COMPANY", "ADMIN"), getSummaryAnalytics);
router.get("/demand/charts", authenticate, authorize("COMPANY", "ADMIN"), getDemandChartsAnalytics);
